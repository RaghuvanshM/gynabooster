          ...
          <ScrollView>
            ...
            <View style={{alignSelf: 'center'}}>
              <TextInput
                ...
                left={
                  <TextInput.Icon name="email" size={25} color={'#C22D0D'} />
                }
              />
              <TextInput
                style={{width: wp('85%'), marginTop: hp('2%')}}
                ...
                left={
                  <TextInput.Icon name="lock" size={25} color={'#C22D0D'} />
                }
            ...
            <View
              ...
              <Pressable>
                <Text style={{color: '#80080a', marginLeft: wp('1%')}}>
                  {' '}
                  Forgot Password ?
                </Text>
              </Pressable>
